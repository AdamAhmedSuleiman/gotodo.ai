...
import { EarningDataPoint } from '../../src/types.js'; 
...
const EarningsChart: React.FC<EarningsChartProps> = React.memo(({ data }) => {
  ...
  return (
    <div className="w-full h-64 md:h-80 bg-white p-0"> {/* Removed padding for true B&W */}
      <ResponsiveContainer width="100%" height="100%">
        ...
        >
          ...
          <XAxis dataKey="date" tick={{ fontSize: 12, fill: '#374151' }} axisLine={{ stroke: '#9ca3af' }} tickLine={{ stroke: '#9ca3af' }} />
          <YAxis tick={{ fontSize: 12, fill: '#374151' }} axisLine={{ stroke: '#9ca3af' }} tickLine={{ stroke: '#9ca3af' }} />
          <Tooltip
